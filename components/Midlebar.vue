      ...
      <div v-for="post in importData" :key="post.id" class="post-body">
        <div class="post-section">
          <div class="pro-img-title">
            <img :src="post.avatar" alt="Visit profile" class="pro-img" />
          </div>
          <br />
          <div class="align">
            <div class="header">
        ...
        <div class="flex-container">
          <div class="post-react">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="wish-match"
