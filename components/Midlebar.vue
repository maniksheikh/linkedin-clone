  ...
  <div>
    <div>
      <div class="middle-container">
        <div class="middle">
          <div class="section">
            <img src="../img/manin.jpg" alt="Visit profile for Md Manik" id="ember480" class="midle-img" />
        ...
        <div class="post-body">
          <div class="post-section">
            <div class="pro-img-title">
              <img src="../img/manin.jpg" alt="Visit profile for Md Manik" id="ember480" class="pro-img" />
            </div>
            <br>
              <div class="align">
                <span class="post-header">Md Manik Sheak</span> <br>
                <span class="id"> FrontEnd Web Developer</span>
                <p>I am happy to share that I've been learning my programming skills here and loving every minute of it.
                  I'm
                  excited to take this passion to the next level and transition from learning to work. Ready to tackle new
                  challenges and contribute to innovative projects with my newfound skills.</p>
              </div>

          </div>
          <div class="height-img">
            <img class="pro-height-img" src="../img/manikbg.png" alt="" />
          </div>
          <hr>
          <div class="flex-container">
            <div class="post-space">
      ...
      <div class="post">
        <div class="post-body">
          <div class="post-section">
            <div class="last-img-title">
              <img src="../img/connekt.jpg" alt="" class="last-image">
            </div>
            <br>
            <div class="align">
              <span class="post-header">CONNEKT STUDIO</span> <br>
              <span class="id"> SOFTWEAR DEVELOPMENT</span>
            </div>
          </div>
          <div class="last-height-img">
            <img src="../img/connekt long.jpg" alt=""
              class="last-height-image">
          </div>
          <hr>
          <div class="flex-container">
            <div class="post-space">
      ...
      <div class="post">
        <div class="post-body">
          <div class="post-section">
            <div class="last-img-title">
              <img src="../img/sml-profile.jpeg" alt="" class="last-image">
            </div>
            <br>
            <div class="align">
              <span class="post-header">CONNEKT STUDIO</span> <br>
          ...
          <div class="last-height-img">
            <img src="../img/hairing.jpeg" alt="" class="last-height-image">
          </div>
          <hr>
          <div class="flex-container">
            <div class="post-space">
        ...
        <div class="post-body">
          <div class="post-section">
            <div class="last-img-title">
              <img src="../img/studio.jpg" alt="" class="last-image">
            </div>
            <br>
            <div class="align">
              <span class="post-header">CONNEKT STUDIO</span> <br>
          ...
          <div class="last-height-img">
            <img src="../img/studio long.jpg" alt="" class="last-height-image">
          </div>
          <hr>
          <div class="flex-container">
            <div class="post-space">
